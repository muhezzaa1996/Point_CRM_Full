                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($rute as $lu) : ?>
                                                        <tr>
                                                            ...
                                                            <?php if ($lu['confirm'] == 1) : ?>
                                                                <td><a href="<?php echo base_url('spv/confirm/' . $lu['id_route']); ?>" class="btn btn-info btn-block btn-sm">KONFIRMASI</a></td>
                                                            <?php else : ?>
                                                                <td><a href="<?php echo base_url('spv/confirm/' . $lu['id_route']); ?>" class="btn btn-success btn-block btn-sm">SUKSES</a></td>
                                                                </td>
                                                            <?php endif; ?>
                                                        </tr>
                                                    <?php endforeach; ?>
