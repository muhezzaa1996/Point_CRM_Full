                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($cabang as $lu) : ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('spv/del_cabang/') . $lu['id_cabang']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm">Hapus</a> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('spv/mst_cabang'); ?>" method="post">
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('spv/edit_cabang'); ?>" method="post">
                        <div class="form-group">
                            <label>Kode Cabang</label>
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('spv/get_cabang'); ?>',
            data: {
                id_cabang: id_cabang
            },
            method: 'post',
