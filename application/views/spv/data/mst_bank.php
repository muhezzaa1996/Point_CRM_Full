                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($bank as $lu) : ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('spv/del_bank/') . $lu['id_bank']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm">Hapus</a> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('spv/mst_bank'); ?>" method="post">
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('spv/edit_bank'); ?>" method="post">
                        <div class="form-group">
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('spv/get_bank'); ?>',
            data: {
                id_bank: id_bank
            },
            method: 'post',
