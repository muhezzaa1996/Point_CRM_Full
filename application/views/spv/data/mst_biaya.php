                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($biaya as $lu) : ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('spv/del_biaya/') . $lu['id_biaya']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm">Hapus</a> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('spv/mst_biaya'); ?>" method="post">
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('spv/edit_biaya'); ?>" method="post">
                        <div class="form-group">
                            <label>Nama Biaya Operasional</label>
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('spv/get_biaya'); ?>',
            data: {
                id_biaya: id_biaya
            },
            method: 'post',
